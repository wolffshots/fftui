...
# Date window (YYYY-MM-DD): only show cycles overlapping [FF_FROM, FF_TO].
# Filters every view (table, analytics, charts, web); leave either side unset
# for an open bound. (--from / --to flags override; --from="" clears for a run.)
# FF_FROM=
# FF_TO=
